...
const REMIX_IDEAS = [
    ...
    "to create a cozy backyard patio.",
    "to visualize a nursery for a new baby.",
    "to generate exterior paint color options.",
    "to plan a perfect home office setup.",
    "to see your room in different lighting.",
];
